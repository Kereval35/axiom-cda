...
public final class CompactObservationMappingCompiler {

    public SemanticMappingModel compile(CompactObservationMapping mapping) {
        if (mapping == null) {
    ...
    private void compileBranch(String groupName,
                               String branchName,
                               CompactObservationBranch branch,
                               List<SemanticRule> rules) {
        if (branch == null) {
            return;
        }
        if (!branch.flavors().isEmpty()) {
            for (Map.Entry<String, CompactObservationFlavor> flavorEntry : branch.flavors().entrySet()) {
    ...
    private void compileFlavor(String groupName,
                               String branchName,
                               String flavorName,
                               CompactObservationFlavor flavor,
                               List<SemanticRule> rules) {
        if (flavor == null) {
            return;
        }
    ...
    private void maybeAddSelfRule(String groupName,
                                  String sourceRoot,
                                  String target,
                                  CompactRelationship relationship,
                                  String onlyType,
                                  String transform,
    ...
    private String groupName(CompactObservationMapping mapping) {
    ...
    private String resolveTransform(CompactRelationship relationship, String declaredTransform) {
