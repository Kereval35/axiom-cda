 ...
 *       &lt;attGroup ref="{}MultiplicityRangeRequired"/&gt;
...
public class Cardinality {
    ...
    @XmlAttribute(name = "minimumMultiplicity", required = true)
    private int minimumMultiplicity;
    @XmlAttribute(name = "maximumMultiplicity", required = true)
     ...
     * 
     */
    public void setMinimumMultiplicity(int value) {
