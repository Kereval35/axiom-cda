export const translations = {
  en: {
    ...
    dashboard: {
      ...
      projectPlusRequiredIncludes: "Project templates plus required includes only",
      projectPlusRequiredIncludesHint: "Keeps project-owned templates and the external templates they still need.",
      ownedRepositoryPrefixes: "Owned repository prefixes",
      ...
      fhirEligible: "Eligible for FHIR Observation conversion",
      convertToFhir: "Convert to FHIR",
      fhirConversionTitle: "FHIR Observation Conversion",
      fhirConversionSubtitle: "Generate FHIR FSH from the selected CDA IR template using the built-in mapping library or an uploaded StructureMap JSON override.",
      useGenericMapping: "Use built-in generic mapping",
      useGenericMappingHint: "Recommended. Turn this off only when you need to override the shipped mapping with your own StructureMap JSON.",
      builtInMappingLabel: "Built-in mapping profile",
      structureMapLabel: "StructureMap JSON Override (Optional)",
      uploadStructureMap: "Click to upload a custom StructureMap JSON override",
      acceptsJson: "Accepts .json files",
      conversionMissingState: "No eligible IR context was found. Generate CDA FSH first and start conversion from an eligible Observation profile.",
      selectedTemplate: "Selected IR Template",
      conversionDiagnostics: "Conversion diagnostics",
      generatedFhirProfiles: "Generated FHIR FSH",
      generatedMappingRules: "Generated Mapping Rules",
      generatedMappingRulesHint: "Companion FSH trace of the effective CDA to FHIR mapping rules used for this conversion.",
      viewMappingRules: "View Mapping Rules",
  ...
  fr: {
    ...
    dashboard: {
      ...
      projectPlusRequiredIncludes: "Templates du projet plus inclusions requises uniquement",
      projectPlusRequiredIncludesHint: "Conserve les templates du projet et les templates externes encore necessaires.",
      ownedRepositoryPrefixes: "Prefixes de repository du projet",
      ...
      fhirEligible: "Éligible à la conversion FHIR Observation",
      convertToFhir: "Convertir en FHIR",
      fhirConversionTitle: "Conversion FHIR Observation",
      fhirConversionSubtitle: "Générez du FHIR FSH à partir du template IR CDA sélectionné en utilisant la librairie de mapping intégrée ou une StructureMap JSON de surcharge.",
      useGenericMapping: "Utiliser le mapping générique intégré",
      useGenericMappingHint: "Recommandé. Désactivez ceci uniquement si vous devez surcharger le mapping fourni avec votre propre StructureMap JSON.",
      builtInMappingLabel: "Profil de mapping intégré",
      ...
      conversionMissingState: "Aucun contexte IR éligible n’a été trouvé. Générez d’abord le FSH CDA puis lancez la conversion depuis un profil Observation éligible.",
      selectedTemplate: "Template IR sélectionné",
      conversionDiagnostics: "Diagnostics de conversion",
      generatedFhirProfiles: "FHIR FSH généré",
      generatedMappingRules: "Règles de mapping générées",
      generatedMappingRulesHint: "Trace FSH compagnon des règles effectives de mapping CDA vers FHIR utilisées pour cette conversion.",
      viewMappingRules: "Voir les règles de mapping",
