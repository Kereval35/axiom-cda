export const translations = {
  en: {
    ...
    dashboard: {
      ...
      fhirConversionSubtitle: "Generate FHIR FSH from the selected CDA IR template and an uploaded StructureMap JSON.",
      structureMapLabel: "StructureMap JSON",
      uploadStructureMap: "Click to upload StructureMap JSON",
  ...
  fr: {
    ...
    dashboard: {
      ...
      fhirConversionSubtitle: "Générez du FHIR FSH à partir du template IR CDA sélectionné et d’un StructureMap JSON téléversé.",
      structureMapLabel: "StructureMap JSON",
      uploadStructureMap: "Cliquez pour téléverser un StructureMap JSON",
